...
import { useMediaQuery } from '@/lib/nutritrack/hooks/useMediaQuery';
...
export function AppShell() {
  ...
  return (
    <div className="flex h-dvh flex-col overflow-hidden bg-nt-bg">
      <AsyncLoadingBar />
      ...
      <div className="mx-auto flex min-h-0 w-full max-w-md flex-1 flex-col lg:max-w-6xl">
        ...
        <div className="flex min-h-0 flex-1 flex-col lg:grid lg:grid-cols-[1fr_400px] lg:gap-4">
          ...
          {isDesktop && (
            <div className="my-3 flex flex-col overflow-hidden rounded-xl border border-nt-border bg-nt-card backdrop-blur-sm">
              <ErrorBoundary>
                <ChatView />
              </ErrorBoundary>
            </div>
